//*Purpose of this class is to keep all icons in one place
//*just make object of this class and get all available icons
...
class AssetPath {
  ...
  static String troubleUrl = "assets/icons/trouble.svg";
  //png
